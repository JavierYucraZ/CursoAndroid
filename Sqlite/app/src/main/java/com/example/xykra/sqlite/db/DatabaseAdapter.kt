package com.example.xykra.sqlite.db

import com.example.xykra.sqlite.Constants
...
class DatabaseAdapter(context: Context) {
    ...
    //factory es nulo porque queremos que use los cursores que vienen por defecto
